...
# Note: load_and_chunk_docs_node is referenced above; to keep this part focused and small, it is implemented
# in the next file (part2). This file contains all core helpers, indexer, retriever, and RAG node implementations.
